...
console.log("Expected output of  array [1,3,5,3,3] multiply by 10 is [10,30,50,30,30]  " + myFunctionTest(JSON.stringify([10, 30, 50, 30, 30]), JSON.stringify(b)));


const c = a.filter(function (elem, i, array) {
  return elem === 3;
});
console.log("Expected output of array [1,3,5,3,3] all element equal to 3 is [3,3,3] " + myFunctionTest(JSON.stringify([3, 3, 3]), JSON.stringify(c)));


const d = a.reduce(function (prevValue, elem, i, array) {
  return prevValue * elem;
});
console.log("Expected output of array [1,3,5,3,3] multiplication of all individual element is 135 " + myFunctionTest(135, d));
